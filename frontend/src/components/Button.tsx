...
export default function Button({
  ...
  const classes = `cursor-pointer transition-[color,background-color,border-color,transform] duration-150 active:duration-75 active:scale-95 inline-flex items-center justify-center ${padClass} ${VARIANT_CLASSES[variant][size]}`;
